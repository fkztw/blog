...
+ 時間管理不夠好、自信不足、應該多嘗試面試邀約  
    ...
    + 期間還有一件事是，2015 年底找工作的時候在 Livecoding.tv 這個平台（現在改名為 LiveEdu）上開了寫程式的實況，後來找到工作後，因為租屋處網路不夠快，所以就沒繼續開了，結果後來發生了幾件事：  
