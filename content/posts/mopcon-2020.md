...
- 《在這個不大不小的醫院，DevOps 欲怎樣落地》
    ...
    - > 「為中小型醫院開源一個通用性的專案」
        - 這個夢想有點偉大，滿敬佩的。
    - 這個議程應該是我在 MOPCON 2020 裡頭最佩服的一個，對我來說，在薪水不高的南部務實地一步步改進醫院裡頭相對落後的資訊系統，真的是需要很強烈的情感才有辦法達到。而且每個環節都闡述得滿清楚的，最後更是用那張最常見的 DevOps Infinity Graphic 把各個環節用到的工具都清楚地列出來。
- 《讓繁體中文自然語言處理落地的困難與機遇》
    - BERT
